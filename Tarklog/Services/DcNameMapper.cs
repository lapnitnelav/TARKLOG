...
namespace Tarklog.Services
{
    ...
    public static class DcNameMapper
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, string> CountryCodeMappings = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            // A
            { "AD", "Andorra" },
        ...
        public static string GetCountryName(string countryCode)
        {
            ...
            if (CountryCodeMappings.TryGetValue(countryCode, out var countryName))
                return countryName;
